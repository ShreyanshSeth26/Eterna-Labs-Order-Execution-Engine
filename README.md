...
- **Redis ECONNREFUSED**Ensure Docker stack is up. Prefer `REDIS_URL=redis://127.0.0.1:6379` in `.env`.
- **WebSocket “missing orderId”**Create an order first, then connect WS using that `orderId` (or use the Postman test script to auto-store it).
- **429 Too Many Requests**You hit the minute cap (`RATE_LIMIT_PER_MIN`). Lower request rate or raise the value in `.env`.
- **Same order returned repeatedly**
  You’re reusing the same `Idempotency-Key`. Change it to create a new order.
...
<style>#mermaid-1762682926702{font-family:sans-serif;font-size:16px;fill:#333;}#mermaid-1762682926702 .error-icon{fill:#552222;}#mermaid-1762682926702 .error-text{fill:#552222;stroke:#552222;}#mermaid-1762682926702 .edge-thickness-normal{stroke-width:2px;}#mermaid-1762682926702 .edge-thickness-thick{stroke-width:3.5px;}#mermaid-1762682926702 .edge-pattern-solid{stroke-dasharray:0;}#mermaid-1762682926702 .edge-pattern-dashed{stroke-dasharray:3;}#mermaid-1762682926702 .edge-pattern-dotted{stroke-dasharray:2;}#mermaid-1762682926702 .marker{fill:#333333;}#mermaid-1762682926702 .marker.cross{stroke:#333333;}#mermaid-1762682926702 svg{font-family:sans-serif;font-size:16px;}#mermaid-1762682926702 .label{font-family:sans-serif;color:#333;}#mermaid-1762682926702 .label text{fill:#333;}#mermaid-1762682926702 .node rect,#mermaid-1762682926702 .node circle,#mermaid-1762682926702 .node ellipse,#mermaid-1762682926702 .node polygon,#mermaid-1762682926702 .node path{fill:#ECECFF;stroke:#9370DB;stroke-width:1px;}#mermaid-1762682926702 .node .label{text-align:center;}#mermaid-1762682926702 .node.clickable{cursor:pointer;}#mermaid-1762682926702 .arrowheadPath{fill:#333333;}#mermaid-1762682926702 .edgePath .path{stroke:#333333;stroke-width:1.5px;}#mermaid-1762682926702 .flowchart-link{stroke:#333333;fill:none;}#mermaid-1762682926702 .edgeLabel{background-color:#e8e8e8;text-align:center;}#mermaid-1762682926702 .edgeLabel rect{opacity:0.5;background-color:#e8e8e8;fill:#e8e8e8;}#mermaid-1762682926702 .cluster rect{fill:#ffffde;stroke:#aaaa33;stroke-width:1px;}#mermaid-1762682926702 .cluster text{fill:#333;}#mermaid-1762682926702 div.mermaidTooltip{position:absolute;text-align:center;max-width:200px;padding:2px;font-family:sans-serif;font-size:12px;background:hsl(80,100%,96.2745098039%);border:1px solid #aaaa33;border-radius:2px;pointer-events:none;z-index:100;}#mermaid-1762682926702:root{--mermaid-font-family:sans-serif;}#mermaid-1762682926702:root{--mermaid-alt-font-family:sans-serif;}#mermaid-1762682926702 flowchart-v2{fill:apa;}</style>
